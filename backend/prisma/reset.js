    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, prisma.selectedOption.deleteMany()];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, prisma.image.deleteMany()];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, prisma.color.deleteMany()];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, prisma.product.deleteMany()];
                case 5:
                    _a.sent();
                    return [4 /*yield*/, prisma.optionValue.deleteMany()];
                case 6:
                    _a.sent();
                    return [4 /*yield*/, prisma.option.deleteMany()];
                case 7:
                    _a.sent();
